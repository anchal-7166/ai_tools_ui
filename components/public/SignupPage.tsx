...
export default function SignupPage() {
  ...
  const { register, isRegisterLoading, registerError, resetRegisterError } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl relative z-10">
        ...
        {/* Error Message */}
        {errorMessage && (
          <div className="mb-6 p-3 bg-red-900/20 border border-red-800 rounded-lg text-red-400 text-sm max-w-4xl mx-auto">
            {errorMessage}
          </div>
        )}

        {/* Two Column Grid */}
        <div className="grid md:grid-cols-2 gap-8 md:gap-0 max-w-4xl mx-auto">
          {/* Left Column - Form */}
          <div className="md:pr-8 md:border-r md:border-neutral-800">
            <h2 className="text-xl font-semibold text-white mb-6">Sign up with email</h2>
            <form onSubmit={handleSubmit} className="space-y-4 max-w-sm">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-black border border-neutral-800 rounded-lg text-white placeholder-neutral-600 focus:outline-none focus:ring-1 focus:ring-red-600 focus:border-transparent transition-all duration-200 disabled:opacity-50"
                  placeholder="johndoe"
                />
              </div>
              ...
              <div>
                <label htmlFor="firstName" className="block text-sm font-medium text-neutral-300 mb-2">
                  First Name <span className="text-neutral-500">(optional)</span>
                </label>
                <input
                  id="firstName"
                  type="text"
              ...
              <div className="flex items-start">
                <input
                  ...
                  disabled={isRegisterLoading}
                  className="w-4 h-4 mt-0.5 bg-black border-neutral-800 rounded text-red-600 focus:ring-1 focus:ring-red-600 focus:ring-offset-0 disabled:opacity-50"
                />
                <label htmlFor="agree-terms" className="ml-2 text-sm text-neutral-400">
                  I agree to the{' '}
          ...
          <div className="flex flex-col justify-center md:pl-8">
            ...
            <h2 className="text-xl font-semibold text-white mb-6 hidden md:block">Quick sign up</h2>
            ...
            <div className="space-y-3 max-w-sm">
              ...
              <div className="pt-4 space-y-3">
                <p className="text-sm text-neutral-500">
                  By signing up with a social provider, you agree to our Terms of Service and Privacy Policy.
                </p>
              </div>
            </div>
          </div>
